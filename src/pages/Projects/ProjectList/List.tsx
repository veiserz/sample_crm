    ...
    return (
        <React.Fragment>
                ...
                <div className="col-sm-auto">
                    <div>
                        <Link to="/apps-projects-create" className="btn btn-success"><i
                            className="ri-add-line align-bottom me-1"></i> افزودن جدید</Link>
                    </div>
                </div>
                <div className="col-sm-3 ms-auto">
                    <div className="d-flex justify-content-sm-end gap-2">
                        ...
                        <select className="form-control w-md" data-choices data-choices-search-false>
                            ...
                            <option value="Last 7 Days">گذشته هفته</option>
                            <option value="Last 30 Days">گذشته ماه</option>
                            <option value="Last Year">گذشته سال</option>
                            <option value="This Month">این ماه</option>
                            <option value="Today">امروز</option>
                            <option value="Yesterday" defaultValue="Yesterday">دیروز</option>
                        </select>
                    </div>
                </div>
            </Row>
                                                    ...
                                                    <div className="d-flex gap-1 align-items-center">
                                                        ...
                                                        <UncontrolledDropdown direction='start'>
                                                            ...
                                                            <DropdownMenu className="dropdown-menu-end">
                                                                <DropdownItem href="apps-projects-overview"><i className="ri-eye-fill align-bottom me-2 text-muted"></i> مشاهده</DropdownItem>
                                                                <DropdownItem href="apps-projects-create"><i className="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</DropdownItem>
                                                                <div className="dropdown-divider"></div>
                                                                <DropdownItem href="#" onClick={() => onClickData(item)} data-bs-toggle="modal" data-bs-target="#removeProjectModal"><i className="ri-delete-bin-fill align-bottom me-2 text-muted"></i> حذف</DropdownItem>
                                                            </DropdownMenu>
                                                ...
                                                <div className="avatar-group">
                                                    {item.subItem.map((item: any, key: number) => (
                                                        <React.Fragment key={key}>
                                                            {item.imgFooter ? <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="دارلین ویلیامز">
                                                                <div className="avatar-xxs">
                                                                    <img src={item.imgFooter} alt="" className="rounded-circle img-fluid" />
                                                                </div>
                                                            </Link> : <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="افزودن اعضا">
                                                                <div className="avatar-xxs">
                                        ...
                                        <CardBody>
                                            ...
                                            <div className="py-3">
                                                <Row className="gy-3">
                                                    ...
                                                    <Col xs={6}>
                                                        <div>
                                                            <p className="text-muted mb-1">مهلت</p>
                                                ...
                                                <div className="d-flex align-items-center mt-3">
                                                    <p className="text-muted mb-0 me-2">تیم :</p>
                                                    <div className="avatar-group">

                                                        {item.subItem.map((item:any, key:number) => (
                                                            <React.Fragment key={key}>
                                                                {item.imgTeam ? <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="دارلین ویلیامز">
                                                                    <div className="avatar-xxs">
                                                                        <img src={item.imgTeam} alt="" className="rounded-circle img-fluid" />
                                                                    </div>
                                                                </Link> : <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="دونا کلاین">
                                                                    <div className="avatar-xxs">
            ...
            <Row className="g-0 text-center text-sm-start align-items-center mb-4">
                <Col sm={6}>
                    <div>
                        <p className="mb-sm-0 text-muted">نمایش <span className="fw-semibold">۱</span> تا <span className="fw-semibold">۱۰</span> از <span className="fw-semibold text-decoration-underline">۱۲</span> ورودی</p>
                    </div>
                </Col>
                ...
                <Col sm={6}>
                    <ul className="pagination pagination-separated justify-content-center justify-content-sm-end mb-sm-0">
                        <li className="page-item disabled">
                            <Link to="#" className="page-link">قبلی</Link>
                        </li>
                        ...
                        <li className="page-item">
                            <Link to="#" className="page-link">بعدی</Link>
                        </li>
                    </ul>
                </Col>
            </Row>

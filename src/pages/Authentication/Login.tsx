                            ...
                            <Row>
                                <Col lg={12}>
                                    <div className="text-center mt-sm-5 mb-4">
                                        ...
                                        <p className="mt-3 fs-15 fw-medium" style={{ color: "#fff" , direction: "rtl"}}>سیستم مدیریت مشتریان</p>
                                    </div>
                                </Col>
                            </Row>
                                ...
                                <Col md={8} lg={6} xl={5}>
                                    <Card className="mt-4">
                                        <CardBody className="p-4">
                                            ...
                                            <h5 className="text-primary" style={{direction: "rtl"}}>به همیار crm خوش آمدید</h5>
    <p className="text-muted"style={{direction: "rtl"}}>لطفاً برای دسترسی به خدمات، وارد حساب کاربری خود شوید.</p>
                                                ...
                                                <Form
                                                    ...
                                                    <div className="mb-3">
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <Link to="/forgot-password" className="text-muted" style={{direction: "ltr", textAlign: "left"}}>رمز عبور را فراموش کرده‌اید؟</Link>
                                                            <Label className="form-label mb-0" style={{direction: "rtl", textAlign: "right"}} htmlFor="password-input">رمز عبور</Label>
                                                        </div>

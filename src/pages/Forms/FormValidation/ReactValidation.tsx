...
const ReactValidation = () => {
    ...
    function handleSubmit(e: any) {
        ...
        var firstnm: any = document.getElementById("validationTooltip01")
        var lastnm: any = document.getElementById("validationTooltip02")
        var usernm: any = document.getElementById("validationTooltipUsername")
        var citynm: any = document.getElementById("validationTooltip03")
        var stateVnm: any = document.getElementById("validationTooltip04")

        var fnm = firstnm.value;
        var lnm = lastnm.value;
        var unm = usernm.value;
        var city = citynm.value;
        var stateV = stateVnm.value;

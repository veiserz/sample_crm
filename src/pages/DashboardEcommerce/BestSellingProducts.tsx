                        ...
                        <div className="flex-shrink-0">
                            <UncontrolledDropdown className="card-header-dropdown" direction='start'>
                                <DropdownToggle tag="a" className="text-reset" role="button">
                                    <span className="fw-semibold text-uppercase fs-13">مرتب‌سازی بر اساس: </span><span className="text-muted">امروز<i className="mdi mdi-chevron-down ms-1"></i></span>
                                </DropdownToggle>
                                <DropdownMenu className="dropdown-menu-end">
                                    <DropdownItem>امروز</DropdownItem>
                                    <DropdownItem>دیروز</DropdownItem>
                                    <DropdownItem>گذشته ۷ روز</DropdownItem>
                                    <DropdownItem>گذشته ۳۰ روز</DropdownItem>
                                    <DropdownItem>این ماه</DropdownItem>
                                    <DropdownItem>گذشته ماه</DropdownItem>
                                </DropdownMenu>
                            </UncontrolledDropdown>
                        </div>
                        <h4 className="card-title mb-0 flex-grow-1" dir="rtl">بیشترین فروشترین محصولات</h4>
                    ...
                    <CardBody>
                                ...
                                <tbody>
                                    {(bestSellingProducts || []).map((item, key) => (
                                        <tr key={key}>
                                            ...
                                            <td>
                                                <h5 className="fs-14 my-1 fw-normal">{item.stock ? item.stock : <span className="badge bg-danger-subtle text-danger">موجودی تمام شده</span>} </h5>
                        ...
                        <div className="align-items-center mt-4 pt-2 justify-content-between row text-center text-sm-start">
                            <div className="col-sm">
                                <div className="text-muted">نمایش <span className="fw-semibold">5</span> از <span className="fw-semibold">25</span> نتایج
                                </div>
                            </div>

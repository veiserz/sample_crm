                    ...
                    <div className="flex-shrink-0">
                            <UncontrolledDropdown className="card-header-dropdown" direction='start'>
                                <DropdownToggle tag="a" className="text-reset dropdown-btn" role="button">
                                    <span className="text-muted">گزارش<i className="mdi mdi-chevron-down ms-1"></i></span>
                                </DropdownToggle>
                                <DropdownMenu className="dropdown-menu dropdown-menu-end">
                                    <DropdownItem>دانلود گزارش</DropdownItem>
                                    <DropdownItem>خروجی</DropdownItem>
                                    <DropdownItem>وارد کردن</DropdownItem>
                                </DropdownMenu>
                            </UncontrolledDropdown>
                        </div>
                        <h4 className="card-title mb-0 flex-grow-1" dir="rtl">بهترین فروشندگان</h4>

                    ...
                    <CardBody className="px-0">
                        <ul className="list-inline main-chart text-center mb-0">
                            ...
                            <li className="list-inline-item chart-border-left me-0">
                                <h4>$497k<span className="text-muted d-inline-block fs-13 align-middle ms-2">هزینه‌ها</span>
                                </h4>
                            </li>
                            <li className="list-inline-item chart-border-left me-0">
                                <h4><span data-plugin="counterup">3.6</span>%<span className="text-muted d-inline-block fs-13 align-middle ms-2">نرخ سود</span></h4>
                            </li>
                        </ul>

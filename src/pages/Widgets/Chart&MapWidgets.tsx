        ...
        <React.Fragment>
            <Row>
                <Col className="col-12">
                    <h5 className="text-decoration-underline mb-3 mt-2 pb-3">چارت و مپ ویجت ها</h5>
                </Col>
            </Row>
                ...
                <Col xxl={4}>
                    <Card className="card-height-100">
                        <CardHeader className="border-0 align-items-center d-flex">
                            <h4 className="card-title mb-0 flex-grow-1">معیارهای مخاطبین</h4>
                            <div>
                                <Button color="secondary" size="sm" className="btn-soft-secondary me-1">
                                    همه
                                </Button>
                        ...
                        <CardHeader className="p-0">
                            <Alert color="warning" className="alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" role="alert">
                                ...
                                <div className="flex-grow-1 text-truncate">
                                    توصیه های آموزشی در <b>17</b> روز تمام شده است.
                                </div>
                                <div className="flex-shrink-0">
                                    <Link to="/pages-pricing" className="text-reset text-decoration-underline"><b>ارتقاء</b></Link>
                                </div>
                            </Alert>
                        </CardHeader>
                    ...
                    <Card className="card-height-100">
                        ...
                        <CardBody>
                            ...
                            <div className="px-2 py-2 mt-1">
                                <p className="mb-1">نیو مکزیکو<span className="float-end">75%</span></p>
                                <Progress color="primary" value={75} striped className="mt-2" style={{ height: "6px" }} />

                                <p className="mt-3 mb-1">کالیفرنیا <span className="float-end">47%</span></p>
                                <Progress color="primary" value={47} striped className="mt-2" style={{ height: "6px" }} />

                                <p className="mt-3 mb-1">تگزاس <span className="float-end">82%</span></p>
                ...
                <Col xxl={4} xl={6}>
                    <Card className="card-height-100">
                        <CardHeader className="border-bottom-dashed align-items-center d-flex">
                            <h4 className="card-title mb-0 flex-grow-1">پرتفوی من</h4>
                            <div>
                        ...
                        <CardBody>
                            ...
                            <Row className="g-3">
                                <Col md={6}>
                                    ...
                                    <div className="d-flex">
                                        <div className="flex-grow-1">
                                            <p className="text-truncate text-muted fs-14 mb-0"><i className="mdi mdi-circle align-middle text-secondary me-2"></i>دیگر</p>
                                        </div>
                                        <div className="flex-shrink-0">
                            ...
                            <div className="mt-2 text-center">
                                <Link to="#" className="text-muted text-decoration-underline">نمایش همه</Link>
                            </div>
                        </CardBody>
                    </Card>
                </Col>

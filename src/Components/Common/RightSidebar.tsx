            ...
            <div>
                ...
                <Offcanvas isOpen={open} toggle={toggleLeftCanvas} direction="end" className="offcanvas-end border-0">
                    <OffcanvasHeader className="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header-dark" toggle={toggleLeftCanvas}>
                        <span className="m-0 me-2 text-white">تنظیمات تم</span>
                    </OffcanvasHeader>
                    <OffcanvasBody className="p-0">
                        <SimpleBar className="h-100">
                            <div className="p-4">
                                <h6 className="mb-0 fw-semibold text-uppercase">محیط</h6>
                                <p className="text-muted">انتخاب محیط.</p>
                                ...
                                <div className="row gy-3">
                                    <div className="col-4">
                                        ...
                                        <h5 className="fs-13 text-center mt-2">عمودی</h5>
                                    </div>
                                    <div className="col-4">
                                        <div className="form-check card-radio">
                                            <input
                                        ...
                                        <h5 className="fs-13 text-center mt-2">افقی</h5>
                                    </div>
                                    <div className="col-4">
                                        <div className="form-check card-radio">
                                            <input
                                        ...
                                        <h5 className="fs-13 text-center mt-2">دو ستونی</h5>
                                    </div>
                                    <div className="col-4">
                                        <div className="form-check card-radio">
                                        ...
                                        <h5 className="fs-13 text-center mt-2">نیمه باکس</h5>
                                    </div>
                                </div>

                                <h6 className="mt-4 mb-0 fw-semibold text-uppercase">رنگ پیش‌فرض</h6>
                                <p className="text-muted">انتخاب Light یا Dark رنگ پیش‌فرض.</p>
                                ...
                                <div className="colorscheme-cardradio">
                                    <div className="row">
                                        <div className="col-4">
                                            ...
                                            <h5 className="fs-13 text-center mt-2">روشن</h5>
                                        </div>
                                        ...
                                        <div className="col-4">
                                            <div className="form-check card-radio dark">
                                                ...
                                                <h5 className="fs-13 text-center mt-2">تیره</h5>
                                        </div>
                                    </div>
                                </div>

                                {layoutType === LAYOUT_TYPES.SEMIBOX && <div id="sidebar-visibility">
                                    <h6 className="mt-4 mb-0 fw-semibold text-uppercase">نمای Sidebar</h6>
                                    <p className="text-muted">انتخاب show یا Hidden نمای Sidebar.</p>
                                    ...
                                    <div className="row">
                                        <div className="col-4">
                                            ...
                                            <h5 className="fs-13 text-center mt-2">نمایش</h5>
                                        </div>
                                        <div className="col-4">
                                            <div className="form-check card-radio">
                                            ...
                                            <h5 className="fs-13 text-center mt-2">پنهان</h5>
                                        </div>
                                    </div>
                                </div>}
                                {layoutType !== LAYOUT_TYPES.TWOCOLUMN && (
                                    <React.Fragment>
                                        {(layoutType === LAYOUT_TYPES.VERTICAL || layoutType === LAYOUT_TYPES.HORIZONTAL) && (<div id="layout-width">
                                            <h6 className="mt-4 mb-0 fw-semibold text-uppercase">عرض محیط</h6>
                                            <p className="text-muted">انتخاب Fluid یا Boxed layout.</p>
                                        ...
                                        <div id="layout-position">
                                            <h6 className="mt-4 mb-0 fw-semibold text-uppercase">موقعیت محیط</h6>
                                            <p className="text-muted">انتخاب Fixed یا Scrollable موقعیت محیط.</p>
                                ...
                                <h6 className="mt-4 mb-0 fw-semibold text-uppercase">رنگ Topbar</h6>
                                <p className="text-muted">انتخاب Light یا Dark Topbar Color.</p>
                                ...
                                {(layoutType === "vertical" || (layoutType === "semibox" && sidebarVisibilitytype === "show")) && (
                                    <React.Fragment>
                                        ...
                                        <div id="sidebar-size">
                                            <h6 className="mt-4 mb-0 fw-semibold text-uppercase">اندازه Sidebar</h6>
                                            <p className="text-muted">انتخاب اندازه Sidebar.</p>
                                            ...
                                            <div className="row">
                                                <div className="col-4">
                                                    ...
                                                    <h5 className="fs-13 text-center mt-2">پیش‌فرض</h5>
                                                </div>
                                                ...
                                                <div className="col-4">
                                                    ...
                                                    <h5 className="fs-13 text-center mt-2">کامپکت</h5>
                                                </div>
                                                ...
                                                <div className="col-4">
                                                    ...
                                                    <h5 className="fs-13 text-center mt-2">کوچک (نمای آیکون)</h5>
                                                </div>
                                        ...
                                        <div id="sidebar-view">
                                            <h6 className="mt-4 mb-0 fw-semibold text-uppercase">نمای Sidebar</h6>
                                            <p className="text-muted">انتخاب Default یا Detached نمای Sidebar.</p>
                                ...
                                {(layoutType === "vertical" || layoutType === "twocolumn" || (layoutType === "semibox" && sidebarVisibilitytype === "show")) && (
                                    <React.Fragment>
                                        <div id="sidebar-color">
                                            <h6 className="mt-4 mb-0 fw-semibold text-uppercase">رنگ Sidebar</h6>
                                            <p className="text-muted">انتخاب Ligth یا Dark رنگ Sidebar.</p>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-4">
                                                    ...
                                                    <h5 className="fs-13 text-center mt-2">گرادیان</h5>
                                                </div>
                                            </div>
                                            <Collapse
                                                isOpen={show}
                                        ...
                                        <div id="sidebar-img">
                                            <h6 className="mt-4 mb-0 fw-semibold text-uppercase">تصاویر Sidebar</h6>
                                            <p className="text-muted">انتخاب تصویر Sidebar.</p>
                                ...
                                <div id="preloader-menu">
                                    <h6 className="mt-4 mb-0 fw-semibold text-uppercase">پرلودر</h6>
                                    <p className="text-muted">انتخاب پرلودر.</p>
                                    ...
                                    <div className="row">
                                        <div className="col-4">
                                            ...
                                            <h5 className="fs-13 text-center mt-2">فعال</h5>
                                        </div>
                                        <div className="col-4">
                                            <div className="form-check sidebar-setting card-radio">
                                                <input
                                            ...
                                            <h5 className="fs-13 text-center mt-2">غیرفعال</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
